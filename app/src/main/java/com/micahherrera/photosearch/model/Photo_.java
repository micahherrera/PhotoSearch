...
package com.micahherrera.photosearch.model;
...
public class Photo_ implements Parcelable{
    ...
    public Photo_(Parcel input){
        ...
        farm = input.readInt();
        ispublic = input.readInt();
        isfriend = input.readInt();
        isfamily = input.readInt();
    }
    ...
    public static final Parcelable.Creator<Photo_> CREATOR
            = new Parcelable.Creator<Photo_>() {
